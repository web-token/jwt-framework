...
final class UrlKeySetFactoryTest extends TestCase
{
    ...
    {
        $this->getHttpClient()->addResponse(new Response(200, [],'Hello World!'));
    ...
    {
        $this->getHttpClient()->addResponse(new Response(404, [],'Not found'));
        $this->getJKUFactory()->loadFromUrl('https://foo.bar/bad/url');
    }
