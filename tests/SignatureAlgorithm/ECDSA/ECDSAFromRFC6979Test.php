...
final class ECDSAFromRFC6979Test extends TestCase
{
    ...
    public static function dataWithVectors(): iterable
    {
        yield [
            new ES256(),
            'sample',
            ...
            sprintf(
                '%s%s',
                self::convertHexToBin('EFD48B2AACB6A8FD1140DD9CD45E81D69D2C877B56AAF991C34D0EA84EAF3716'),
                self::convertHexToBin('F7CB1C942D657C41D436C7A1B6E29F65F3E900DBB9AFF4064DC4AB2F843ACDA8')
            ),
        ];
        yield [
            new ES256(),
            ...
            sprintf(
                '%s%s',
                self::convertHexToBin('F1ABB023518351CD71D881567B1EA663ED3EFCF6C5132B354F28D3B0B7D38367'),
                self::convertHexToBin('019F4113742A2B14BD25926B49C649155F267E60D3814B4C0CC84250E46F0083')
            ),
        ];
        yield [
            new ES384(),
     ...
     * @return string
     */
    private static function convertHexToBin($data)
    {
        return hex2bin($data);
    }
}
